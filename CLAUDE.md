...
/assets/sprites/buildings → map building sprites (M4S2): fakeatent.png (real art, Jeff's own AI-generated tent). The Tall Tower (M4S3) and the Gym (M4S4) still draw as colored emoji markers — no art sourced yet
