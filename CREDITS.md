...
| Brickhemoth *(placeholder name — Banvengeance's borrowed art)* (front/back/idle sprites) | `assets/sprites/{front,back,idle}/brickhemoth.png` | `mods/tuxemon/gfx/sprites/battle/brickhemoth-sheet.png` | Brickhemoth | Design and front sprite by Serpexnessie; Back and face sprites by Jaskrendix, based on the front sprite | CC BY-SA 3.0 (per wiki.tuxemon.org/Brickhemoth) |
| Crustagu *(placeholder name — Saurchin's borrowed art)* (front/back/idle sprites) | `assets/sprites/{front,back,idle}/crustagu.png` | `mods/tuxemon/gfx/sprites/battle/crustagu-sheet.png` | Crustagu | Design and art by BrasioPkmn; Front and back sprites by Jaskrendix and HippasusTwo; Face sprites by JaskRendix | CC BY-SA 3.0 (per wiki.tuxemon.org/Crustagu) |
| Nimbulex *(placeholder name — Gastronium's borrowed art)* (front/back/idle sprites) | `assets/sprites/{front,back,idle}/nimbulex.png` | `mods/tuxemon/gfx/sprites/battle/nimbulex-sheet.png` | Nimbulex | Front sprite by Spalding004; Back and face sprites by Jaskrendix | CC BY-SA 3.0 (per wiki.tuxemon.org/Nimbulex) |
| Lightmare *(placeholder name — Tobishimi's borrowed art)* (front/back/idle sprites) | `assets/sprites/{front,back,idle}/lightmare.png` | `mods/tuxemon/gfx/sprites/battle/lightmare-sheet.png` | Lightmare | Original design and sprites by Serpexnessie; Back sprite tweaked by Sanglorian | CC BY-SA 3.0 (per wiki.tuxemon.org/Lightmare) |
