...
| The Lagoon tileset (composed) | `assets/tilesets/lagoon.png` | derived from the two George tilesets above — built by `tools/make-lagoon-tileset.mjs`, whose RECIPE list names every source tile | — | tiles by George_; selection/composition ours | CC BY 3.0 (derived work, credit George_) |
